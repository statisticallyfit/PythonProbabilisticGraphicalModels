...
def all_getObservedVars(model: BayesianModel,
    ...
    startBackdoors: Dict[Name, List[Set[Name]]] = backdoorAdjustSets(model, startVar, notation = None)
    endBackdoors: Dict[Name, List[Set[Name]]] = backdoorAdjustSets(model, endVar, notation = None)
